...
const WareHouseManagementPage = lazy(() => import(/* webpackChunkName: "with-search" */ '@/pages/wareHouse/ware-house-management'));
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <WrapperRouteComponent element={<WareHouseManagementPage />} titleId="title.account" />,
      },
      {
        path: '*',
